...
export default class ExerciseList extends BaseModel{
  constructor(options){
    this._name = "exercise_lists" //TODO: Use introspection to not need this
  ...
  postSave(){
    console.log("excersice list post save example")
  }
